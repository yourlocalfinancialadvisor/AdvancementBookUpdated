...
public class AdvancementBookStandBlockEntity extends BlockEntity implements Nameable {
	...
	public AdvancementBookStandBlockEntity(BlockPos pos, BlockState state) {
	   super(ModBlockEntityTypes.ADVANCEMENT_BOOKSTAND, pos, state);
	}
	...
	public static void tick(World world, BlockPos pos, BlockState state, AdvancementBookStandBlockEntity blockEntity) {
